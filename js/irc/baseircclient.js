...
qwebirc.irc.RegisteredCTCPs = new QHash({
  "VERSION": function(x) {
  return "mwebirc v" + qwebirc.VERSION + ", originally qwebirc (C) 2008-2018 Chris Porter & project; modernized 2025 -- transport: " + this.connection.transportStatus + " -- " + qwebirc.util.browserVersion();
  },
